	...
	<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr><td height="2"></td></tr>
		    ...
		    <tr><td id="navbg1" class="left_nav_closed" ><div class="font1">薪水管理</div></td></tr>
		  <tr valign="top" id="submenu1" style="display: none">
		    <td class="left_nav_bgshw" height="50">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="sal/selectSal" target="main">薪水查询</a></img></p>
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="sal/addSal?flag=1" target="main">添加薪水</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr> 
		  ...
		  <tr><td id="navbg3" class="left_nav_closed" ><div class="font1">职位管理</div></td></tr>
		  ...
		  <tr><td id="navbg4" class="left_nav_closed" ><div class="font1">员工管理</div></td></tr>
		  ...
		  <tr><td id="navbg5" class="left_nav_closed" ><div class="font1">公告管理</div></td></tr>
		  ...
		  <tr><td id="navbg6" class="left_nav_closed" onClick="showsubmenu(6)"><div class="font1">下载中心</div></td></tr>
